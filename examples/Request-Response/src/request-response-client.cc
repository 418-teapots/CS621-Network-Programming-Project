...
RequestResponseClient::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::RequestResponseClient")
    ...
    .AddTraceSource ("Rx", "A packet has been received",
                     MakeTraceSourceAccessor (&RequestResponseClient::m_rxTrace),
                     "ns3::Packet::TracedCallback")
    .AddTraceSource ("TxWithAddresses", "A new packet is created and is sent",
                     MakeTraceSourceAccessor (&RequestResponseClient::m_txTraceWithAddresses),
                     "ns3::Packet::TwoAddressTracedCallback")
    .AddTraceSource ("RxWithAddresses", "A packet has been received",
                     MakeTraceSourceAccessor (&RequestResponseClient::m_rxTraceWithAddresses),
                     "ns3::Packet::TwoAddressTracedCallback")
  ;
  return tid;
}
