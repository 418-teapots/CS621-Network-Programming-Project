...
#include "cs621-ppp-net-device.h"
// Kei on 3/4.
...
// Kei on 3/3.   
void 
PointToPointNetDevice::SetCompressionFlag(bool b) {
  compression_enabled = b;
}
bool
PointToPointNetDevice::GetCompressionFlag(void) {
  ...
  uint16_t protocolNumber)
{
  ...
  if (compression_enabled) {
    cout << "protocolNumber: " << protocolNumber << endl;                                             
    
    // Replace protocol number 0x0021 with 0x4021. 


    // Take out the data and prepend the protocol number 0x0021 to it.
    ...
    // Put the compressed data into the packet data. 
